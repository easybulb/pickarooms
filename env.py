...
# Cloudinary Configuration - easybulb@gmail.com
os.environ['CLOUDINARY_CLOUD_NAME'] = 'dkqpb7vwr'
os.environ['CLOUDINARY_API_KEY'] = '475218196462836'
os.environ['CLOUDINARY_API_SECRET'] = 'VDsDshXBr9rZAWrPMxDStqCNwhc'
